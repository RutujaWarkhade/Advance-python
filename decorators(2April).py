# -*- coding: utf-8 -*-
"""
Created on Wed Apr  2 08:24:00 2025
...
calls[0] represent the oldest function call
in list.

now is the current time when the function is 
being called.

if that time exceeds time_frame,
it means the function call is no longer
within the allowed window, so it can be removed

action: calls.pop(0)

remove the oldest timestamp from calls to keep only the

"""
@rate_limiter(2,5) #max 2 calls in 5 seconds
def say_hello():
    print("hello!")
